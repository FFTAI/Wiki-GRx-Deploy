...
def parse_robot_state(state_dict):
    ...
    tuple: A tuple containing the following elements in order:
           ...
           - joint_position (list[float]): Position of each joint in degrees.
           - joint_velocity (list[float]): Velocity of each joint in degrees per
             second.
