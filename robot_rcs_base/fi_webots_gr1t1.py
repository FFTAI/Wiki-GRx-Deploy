...
class WebotsGR1T1(WebotsRobot):
    def __init__(self, sim_dt):
        ...
        self.joint_pd_control_kd = numpy.array([
            ...
            0.2, 0.2, 0.2,  # head(3)
            2.575, 2.575, 3.1, 3.1, 0.2, 0.2, 0.2,  # left arm(7)
            2.575, 2.575, 3.1, 3.1, 0.2, 0.2, 0.2,  # right arm(7)
        ])
        self.joint_pd_control_max = numpy.array([
            ...
            38.0, 38.0, 30.0, 30.0, 10.0, 3.95, 3.95,  # left arm(7)
            38.0, 38.0, 30.0, 30.0, 10.0, 3.95, 3.95,  # right arm(7)
        ])
